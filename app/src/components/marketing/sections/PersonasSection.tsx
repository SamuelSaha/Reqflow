/**
 * Personas Section — Who uses Reqflow
 * SSR, ported from original Personas.tsx
 */
...
const personas = [
  {
    ...
    quote:
      'I need to see where every dollar goes without chasing receipts across a dozen channels.',
    features: [
  ...
  },
  {
    ...
    quote:
      "I just want to buy what I need without a 3-page form and a two-week wait.",
    features: [
  ...
  },
  {
    ...
    quote:
      'I need guardrails that enforce themselves, not ones I have to babysit.',
    features: [
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-14">
          ...
          <p className="text-body-lg text-slate-600 max-w-2xl">
            Whether you handle finances, ship code, or keep operations running, Reqflow gives you a
            view shaped around your decisions.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {personas.map((persona, i) => (
            <div
              key={i}
              className="rounded-2xl border border-slate-200 bg-white p-8 flex flex-col hover:shadow-md transition-shadow"
            >
              {/* Avatar + Info */}
              <div className="flex items-center gap-3 mb-6">
                <div
                  className={`w-10 h-10 rounded-full ${persona.avatarColor} flex items-center justify-center text-white font-bold text-sm`}
                >
