/**
 * Integrations Section — Connected tools grid
 * SSR, ported from original Integrations.tsx
 */
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-14">
          ...
          <p className="text-body-lg text-slate-600 max-w-2xl">
            One-click integrations with your accounting, chat, and identity tools. Data flows both
            ways, so nothing needs manual entry.
          </p>
        </div>
        ...
        <div className="grid grid-cols-3 md:grid-cols-6 gap-6">
          {integrations.map((integration) => (
            <div
              ...
              className="rounded-2xl border border-slate-200 bg-white p-6 flex flex-col items-center gap-4 hover:shadow-md transition-shadow duration-200"
            >
              <div
                className={`w-14 h-14 rounded-2xl ${integration.color} flex items-center justify-center`}
              >
