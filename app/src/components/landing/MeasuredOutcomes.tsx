      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-14">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-lg border border-blue-200 bg-blue-50 mb-5">
            ...
            <span className="text-caption font-semibold text-blue-600 uppercase tracking-wider">Measured Outcomes</span>
          </div>
          <h2 className="text-h2 text-slate-900">
            What happens when buying<br />stops being a mess.
          </h2>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {outcomes.map((outcome, i) => (
            <div key={i} className="rounded-2xl border border-slate-200 bg-white p-8">
              ...
              <div className="text-body font-semibold text-slate-900 mb-1">
                {outcome.title}
              </div>
