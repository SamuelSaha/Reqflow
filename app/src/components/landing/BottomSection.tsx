      ...
      <div className="flex gap-16">
        ...
        <div className="flex-1 grid grid-cols-3 gap-16">
          <div className="flex flex-col gap-4">
            ...
            {["Features", "Pricing", "Integrations", "Changelog"].map(
              (link) => (
                <span
                  key={link}
                  className="text-[14px] text-slate-400 cursor-pointer hover:text-white transition-colors"
                >
                  {link}
                </span>
              )
          ...
          <div className="flex flex-col gap-4">
            ...
            {["Documentation", "API Reference", "Security", "Status"].map(
              (link) => (
                <span
                  key={link}
                  className="text-[14px] text-slate-400 cursor-pointer hover:text-white transition-colors"
        ...
        <div className="flex items-center gap-6">
          {["Privacy Policy", "Terms of Service", "Cookie Policy"].map(
            (link) => (
              <span
                key={link}
                className="text-[13px] text-slate-400 cursor-pointer hover:text-white transition-colors"
              >
                {link}
              </span>
            )
