    ...
    <section className="bg-gradient-to-b from-white via-slate-50/50 to-blue-50 p-20 flex flex-col items-center gap-16">
      ...
      <div className="max-w-[1200px] flex gap-12 items-center">
        <div className="flex-1 flex flex-col gap-5">
          ...
          <h3 className="text-[28px] font-bold tracking-tight text-gray-900">
        ...
        <div className="w-[520px] h-[380px] bg-white rounded-xl border border-gray-200 p-5 overflow-hidden flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-3 flex-1">
            <div className="flex flex-col gap-1">
              ...
              <div className="border border-gray-200 rounded-md px-3 py-1.5 text-[12px] text-gray-900">
            ...
            <div className="flex gap-3">
              <div className="flex-1 flex flex-col gap-1">
                ...
                <div className="border border-gray-200 rounded-md px-3 py-1.5 text-[12px] text-gray-900 flex items-center justify-between">
            ...
            <div className="flex flex-col gap-1 flex-1">
              ...
              <div className="border border-gray-200 rounded-md px-3 py-1.5 text-[12px] text-gray-400 flex-1">
                Explain why this purchase is needed...
              </div>
            </div>
          </div>
          <div className="flex items-center justify-end gap-2">
            <button className="border border-gray-200 rounded-md px-3 py-1.5 text-[12px] font-medium text-gray-600">
              Save Draft
            </button>
      ...
      <div className="max-w-[1200px] flex gap-12 items-center">
        <div className="w-[520px] h-[380px] bg-white rounded-xl border border-gray-200 p-5 overflow-hidden flex flex-col gap-4">
          <div className="flex items-center justify-between">
            <span className="font-bold text-gray-900">Approval Chain</span>
      ...
      <div className="max-w-[1200px] flex gap-12 items-center">
        ...
        <div className="w-[520px] h-[380px] bg-white rounded-xl border border-gray-200 p-5 overflow-hidden flex flex-col gap-4">
          <div className="flex items-center justify-between">
            <span className="font-bold text-gray-900">Budget Overview</span>
            <span className="text-[11px] font-medium text-gray-500">
              Q1 2025
            </span>
          </div>
  ...
  return (
    <section className="bg-gradient-to-b from-white via-slate-50/40 to-blue-50 py-20 px-[120px] flex flex-col gap-16">
      <div className="text-center flex flex-col items-center gap-4">
        ...
        <p className="text-[18px] leading-relaxed text-gray-600 max-w-[600px]">
      ...
      <div className="grid grid-cols-3 gap-6">
        ...
        <div className="bg-white rounded-2xl border border-gray-200 overflow-hidden flex flex-col">
          <div className="p-7 pb-5 flex flex-col gap-3">
            ...
            <p className="text-[14px] leading-relaxed text-gray-600 italic">
          ...
          <div className="p-7 pb-5 flex flex-col gap-3">
            <div className="flex items-center gap-3">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-[13px] text-gray-500">Ops Manager</span>
              </div>
            </div>
            <p className="text-[14px] leading-relaxed text-gray-600 italic">
