    ...
    <PageShell>
      <section className="pt-20 pb-20 px-20">
        <div className="max-w-[800px] mx-auto">
          <h1 className="text-[48px] font-extrabold tracking-tight text-slate-900 mb-4">Terms of Service</h1>
          <p className="text-[15px] text-slate-500 mb-12">Last updated: February 2026 · Beta version</p>

          <div className="bg-amber-50 border border-amber-200 rounded-xl p-6 mb-12">
            <h3 className="text-[18px] font-bold text-amber-600 mb-3">Beta Terms</h3>
            <p className="text-[15px] text-slate-600 leading-[1.7]">These are beta terms. We're being as fair as possible while acknowledging this is early-stage software. If something doesn't work as described, we'll refund you. No questions asked.</p>
          </div>
          ...
          <div className="mb-12">
            <h2 className="text-[24px] font-bold text-slate-900 mb-5">2. Beta Program Terms</h2>
            <div className="space-y-4 text-[17px] text-slate-600 leading-[1.7]">
          ...
          <div className="mb-12">
            <h2 className="text-[24px] font-bold text-slate-900 mb-5">3. Payment & Billing</h2>
          ...
          <div className="mb-12">
            <h2 className="text-[24px] font-bold text-slate-900 mb-5">4. Acceptable Use</h2>
            <p className="text-[17px] text-slate-600 leading-[1.7] mb-4">You may not:</p>
            <ul className="text-[17px] text-slate-600 leading-[1.9] pl-6 list-disc">
          ...
          <div className="mb-12">
            <h2 className="text-[24px] font-bold text-slate-900 mb-5">5. Data Ownership & Privacy</h2>
            <div className="space-y-4 text-[17px] text-slate-600 leading-[1.7]">
          ...
          <div className="mb-12">
            <h2 className="text-[24px] font-bold text-slate-900 mb-5">7. Limitation of Liability</h2>
            <div className="space-y-4 text-[17px] text-slate-600 leading-[1.7]">
          ...
          <div className="mb-12">
            <h2 className="text-[24px] font-bold text-slate-900 mb-5">8. Account Termination</h2>
            <div className="space-y-4 text-[17px] text-slate-600 leading-[1.7]">
          ...
          <div className="mb-12">
            <h2 className="text-[24px] font-bold text-slate-900 mb-5">9. Changes to Terms</h2>
            <p className="text-[17px] text-slate-600 leading-[1.7]">We'll notify you 30 days before any material changes via email. Continued use after changes means acceptance. If you don't agree, cancel before the changes take effect.</p>
          </div>

          <div className="mb-12">
            <h2 className="text-[24px] font-bold text-slate-900 mb-5">10. Governing Law</h2>
            <p className="text-[17px] text-slate-600 leading-[1.7]">These Terms are governed by French law. Any disputes will be resolved in Paris, France. (We're based here, and our data is hosted in the EU.)</p>
          </div>

          <div className="mb-12">
            <h2 className="text-[24px] font-bold text-slate-900 mb-5">Contact</h2>
            <p className="text-[17px] text-slate-600 leading-[1.7]">Questions about these terms: <a href="mailto:legal@reqflow.co" className="text-blue-600 font-semibold no-underline">legal@reqflow.co</a></p>
          </div>
        </div>
      </section>
    </PageShell>
