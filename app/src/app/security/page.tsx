      ...
      <section className="pt-20 pb-20 px-20">
        <div className="max-w-[900px] mx-auto">
          ...
          <div className="bg-amber-50 border border-amber-200 rounded-xl p-6 mb-12">
            <h3 className="text-[18px] font-bold text-amber-600 mb-3">Beta Security Status</h3>
            <p className="text-[15px] text-slate-600 leading-[1.7] mb-3">We take security seriously, but we're in early beta. What this means:</p>
            <ul className="text-[15px] text-slate-600 leading-[1.8] pl-5 list-disc">
          ...
          <div className="mb-12">
            <h2 className="text-[24px] font-bold text-slate-900 mb-5">Infrastructure Security</h2>
            <div className="grid gap-4">
              <div className="bg-slate-50 border border-slate-200 rounded-xl p-7">
                <h3 className="text-[18px] font-bold text-blue-600 mb-3">Hosting & Data Location</h3>
                <p className="text-[15px] text-slate-600 leading-[1.7] mb-3"><strong className="text-slate-900">EU-only hosting:</strong> All data stored in Paris (France) on Oracle Cloud Free Tier infrastructure.</p>
                <p className="text-[15px] text-slate-600 leading-[1.7]"><strong className="text-slate-900">Database:</strong> PostgreSQL on Neon (EU region), encrypted at rest with AES-256.</p>
              </div>
              <div className="bg-slate-50 border border-slate-200 rounded-xl p-7">
                <h3 className="text-[18px] font-bold text-blue-600 mb-3">Data Encryption</h3>
                <p className="text-[15px] text-slate-600 leading-[1.7] mb-3"><strong className="text-slate-900">At rest:</strong> PostgreSQL on Neon uses AES-256 encryption for all data at rest.</p>
                <p className="text-[15px] text-slate-600 leading-[1.7]"><strong className="text-slate-900">In transit:</strong> All connections use TLS 1.3 (HTTPS for web, encrypted connections for database/Redis).</p>
              </div>
              <div className="bg-slate-50 border border-slate-200 rounded-xl p-7">
                <h3 className="text-[18px] font-bold text-blue-600 mb-3">Backup & Recovery</h3>
                <p className="text-[15px] text-slate-600 leading-[1.7] mb-3"><strong className="text-slate-900">Automated backups:</strong> Neon provides point-in-time recovery (PITR) with 7-day retention.</p>
                <p className="text-[15px] text-slate-600 leading-[1.7]"><strong className="text-slate-900">Recovery testing:</strong> We test backup restoration monthly (beta: not yet automated).</p>
              </div>
            </div>
          </div>

          <div className="mb-12">
            <h2 className="text-[24px] font-bold text-slate-900 mb-5">Application Security</h2>
            <div className="grid gap-4">
              <div className="bg-slate-50 border border-slate-200 rounded-xl p-7">
                <h3 className="text-[18px] font-bold text-blue-600 mb-3">Authentication</h3>
                <div className="space-y-3 text-[15px] text-slate-600 leading-[1.7]">
              ...
              <div className="bg-slate-50 border border-slate-200 rounded-xl p-7">
                <h3 className="text-[18px] font-bold text-blue-600 mb-3">Access Control</h3>
                <div className="space-y-3 text-[15px] text-slate-600 leading-[1.7]">
              ...
              <div className="bg-slate-50 border border-slate-200 rounded-xl p-7">
                <h3 className="text-[18px] font-bold text-blue-600 mb-3">API Security</h3>
                <div className="space-y-3 text-[15px] text-slate-600 leading-[1.7]">
          ...
          <div className="mb-12">
            <h2 className="text-[24px] font-bold text-slate-900 mb-5">Incident Response</h2>
            <div className="bg-slate-50 border border-slate-200 rounded-xl p-8 space-y-4">
              <p className="text-[17px] text-slate-600 leading-[1.7]"><strong className="text-slate-900">Monitoring:</strong> Axiom for logs, Sentry for errors, Uptime Robot for availability (beta: basic monitoring, will be enhanced).</p>
              <p className="text-[17px] text-slate-600 leading-[1.7]"><strong className="text-slate-900">Incident notification:</strong> If a security incident affects your data, we'll notify you within 24 hours via email.</p>
              <p className="text-[17px] text-slate-600 leading-[1.7]"><strong className="text-slate-900">Beta-specific:</strong> During beta, founders have direct access to all systems. Minimal team = reduced insider risk.</p>
            </div>
          </div>

          <div className="mb-12">
            <h2 className="text-[24px] font-bold text-slate-900 mb-5">Compliance Roadmap</h2>
          ...
          <div className="mb-12">
            <h2 className="text-[24px] font-bold text-slate-900 mb-5">Responsible Disclosure</h2>
          ...
          <div className="mb-12">
            <h2 className="text-[24px] font-bold text-slate-900 mb-5">Questions?</h2>
