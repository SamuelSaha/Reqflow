        ...
        <Container size="default">
          <div className="text-center max-w-[700px] mx-auto mb-16">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-violet-200 bg-violet-50 mb-6">
              ...
              <span className="text-[13px] font-semibold text-violet-900">For Finance</span>
            </div>
          ...
          <div className="bg-slate-900 rounded-2xl border border-slate-700 p-12 text-white mb-16">
            <h2 className="text-[28px] font-bold mb-8 text-center">What finance teams gain</h2>
            <div className="grid md:grid-cols-3 gap-8">
              <div className="text-center">
                <div className="text-[48px] font-bold text-blue-400 mb-2">5x</div>
                <div className="text-[16px] text-slate-300">
                  Faster audit prep (from weeks to days)
                </div>
              </div>
              <div className="text-center">
                <div className="text-[48px] font-bold text-green-400 mb-2">100%</div>
                <div className="text-[16px] text-slate-300">
