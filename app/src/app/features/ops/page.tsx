        ...
        <Container size="default">
          <div className="text-center max-w-[700px] mx-auto mb-16">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-green-200 bg-green-50 mb-6">
              ...
              <span className="text-[13px] font-semibold text-green-900">For Ops Teams</span>
            </div>
          ...
          <div className="mb-16">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-white rounded-xl border border-slate-200 shadow-sm p-8">
                <h3 className="text-[20px] font-bold text-slate-900 mb-4">Before Reqflow</h3>
                <ul className="space-y-3">
                  {[
                    ...
                    <li key={item} className="flex items-start gap-2 text-[15px] text-slate-600">
              ...
              <div className="bg-green-50 border border-green-200 rounded-xl p-8">
                <h3 className="text-[20px] font-bold text-slate-900 mb-4">With Reqflow</h3>
                <ul className="space-y-3">
                  {[
          ...
          <div className="bg-slate-900 rounded-2xl border border-slate-700 p-12 text-white mb-16">
            <h2 className="text-[28px] font-bold mb-8 text-center">Time back in your week</h2>
            <div className="grid md:grid-cols-3 gap-8">
              <div className="text-center">
                <div className="text-[48px] font-bold text-blue-400 mb-2">8h</div>
                <div className="text-[16px] text-slate-300">
                  Saved per week chasing approvals
                </div>
              </div>
              <div className="text-center">
                <div className="text-[48px] font-bold text-green-400 mb-2">90%</div>
                <div className="text-[16px] text-slate-300">
                  Reduction in manual data entry
                </div>
              </div>
              <div className="text-center">
                <div className="text-[48px] font-bold text-violet-400 mb-2">&lt;30min</div>
                <div className="text-[16px] text-slate-300">
          ...
          <div className="text-center bg-green-50 border border-green-200 rounded-2xl p-10">
            ...
            <a
              href="/beta"
              className="inline-flex items-center gap-2 bg-green-600 text-white px-8 py-4 rounded-lg text-[16px] font-semibold hover:bg-green-700 transition-colors no-underline"
            >
