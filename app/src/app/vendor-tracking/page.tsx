        ...
        <Container size="default">
          <div className="text-center max-w-[700px] mx-auto mb-16">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-green-200 bg-green-50 mb-6">
              ...
              <span className="text-[13px] font-semibold text-green-900">Vendor Tracking</span>
            </div>
          ...
          <div className="mb-16">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-white rounded-xl border border-slate-200 shadow-sm p-8">
                <h3 className="text-[20px] font-bold text-slate-900 mb-4">Current state</h3>
            ...
            <div className="bg-white rounded-xl border border-slate-200 shadow-sm p-8 flex items-start gap-6">
              ...
              <div>
                ...
                <div className="bg-slate-50 rounded-lg p-4 border border-slate-200">
                  <div className="text-[14px] font-semibold text-slate-900 mb-2">Example extraction:</div>
          ...
          <div className="bg-slate-50 rounded-2xl border border-slate-200 p-10 mb-16">
            <h2 className="text-[24px] font-bold text-slate-900 mb-6 text-center">
