    ...
    <PageShell>
      <section className="pt-20 pb-20 px-20">
        <div className="max-w-[800px] mx-auto">
          <h1 className="text-[48px] font-extrabold tracking-tight text-slate-900 mb-6">
            Why We're Building Reqflow
          </h1>

          <div className="text-[19px] text-slate-600 leading-[1.8] mb-12 space-y-6">
          ...
          <div className="bg-slate-50 border border-slate-200 rounded-xl p-10 mb-12">
            <h2 className="text-[24px] font-bold text-slate-900 mb-5">Where We Are Today</h2>
            ...
            <div className="grid gap-5">
              {[
                ...
                <div key={i} className="bg-slate-50 border border-slate-200 rounded-xl p-6">
                  <h3 className="text-[18px] font-bold text-blue-600 mb-2">{item.title}</h3>
                  <p className="text-[15px] text-slate-600 leading-[1.7]">{item.desc}</p>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="bg-slate-50 border border-slate-200 rounded-xl p-10 mb-12">
            <h2 className="text-[24px] font-bold text-slate-900 mb-5">Who's Building This</h2>
            <div className="space-y-4 text-[17px] text-slate-600 leading-[1.7]">
          ...
          <div className="text-center py-12">
            <p className="text-[17px] text-slate-600 mb-6">Interested in shaping this with us?</p>
            <a href="/beta" className="inline-block bg-blue-600 text-white px-8 py-3.5 rounded-lg text-[16px] font-bold no-underline hover:bg-blue-700 transition-colors">
